...
<script src="${pageContext.request.contextPath}/admin/js/bootstrap.min.js"></script><!-- 这个居然要放在最后才可以！！！太坑了吧！！！ -->
...
<div style="width: 1200px; margin: 0 auto;">
	<c:if test="${curSection.id==11}">
		<h1 align="center">打卡记录</h1>
	</c:if>
	<c:if test="${curSection.id!=11}">
	<h1 align="center">欢迎参与${section.name }话题！</h1>
...
<div style="width: 1200px; margin: 0 auto;">
	...
	<c:if test="${curSection.id==11}">
		<a class="" href="Topic_preSave.action?sectionId=${section.id }"><img alt="打卡" src="${pageContext.request.contextPath}/images/card.jpg"></a>
	</c:if>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 8;">
		<!-- 置顶评论 -->
		<!-- <tr height="30">
			<td style="text-indent:5;" background="images/index/classT.jpg"><b><font color="white">■ 置顶评论</font></b></td>
		</tr> -->
		<tr>
			<td>
		...
		<!-- 其他评论 -->
		<!-- <tr height="30">
			<td style="text-indent:5;" background="images/index/classT.jpg"><b><font color="white">■ 其它评论</font></b></td>
		</tr> -->
	...
	<table class="table table-bordered table-striped with-check">
		<tr>
			<th style="text-align: center;vertical-align: middle;">主题</th>
			<th style="text-align: center;vertical-align: middle;">照片</th>
			<th style="text-align: center;vertical-align: middle;">内容</th>
			<th style="text-align: center;vertical-align: middle;">打卡时间</th>
		</tr>
		
		<c:forEach items="${cardList }" var="topic">
		<tr>
			<td style="text-align: center;vertical-align:middle;">
				${topic.title }
			</td>
			<td style="text-align: center;vertical-align: middle;">
			<img alt="" src="${pageContext.request.contextPath}/${topic.image}"
								style="width: 100px; height: 100px;">
			</td>
			<td style="text-align: center;vertical-align: middle;">${topic.content }</td>
