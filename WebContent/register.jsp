...
<body>
	...
	<div class="" align="center" style="margin-top: 50px;">
			<h1 style="margin-bottom: 30px;">创建账号，缘分速达</h1>
		<form id="regForm" style="width: 700px;" enctype="multipart/form-data" class="form-horizontal form-inline" method="post" action="User_register.action" onsubmit="return checkForm()">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<input class="input-block-level" type="text" id="trueName" name="user.trueName" value="${user.trueName }"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="stuId">学号(*)：</label>
				<div class="controls">
					<%-- <input class="input-block-level" type="text" id="stuId" name="user.stuId" onblur="checkStuId(this.value)" value="${user.stuId }"/><span class="pull-left"></span> --%>
					<input class="input-block-level" type="text" id="stuId" name="user.stuId" value="${user.stuId }"/><span class="pull-left"></span>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label" for="face">上传照片(*)：</label>
				<div class="controls">
